export type CalEvent = {
  ...
  startTime: string;
  endTime: string;
  type: "enquiry" | "confirmed" | "paid" | "blocked";
};
...
type BookingCalendarOptions = {
  ...
  /** Custom status-to-type mapping. Falls back to default if not provided. */
...
export function bookingToCalEvent(b: BookingCalendarSource, options: BookingCalendarOptions = {}): CalEvent | null {
